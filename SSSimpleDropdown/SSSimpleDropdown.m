...
- (id)initListViewWithData:(NSArray *)items parentView:(UIView *)parentView locationView:(UIView *)locationView {
    ...
    if(self) {
        ...
        _locationViewX     = CGRectGetMinX(locationView.frame);
        _locationViewY     = CGRectGetMaxY(locationView.frame);
        _locationViewWidth = CGRectGetWidth(locationView.frame);
        ...
        [parentView addSubview:_listView];
        _listView.frame = CGRectMake(_locationViewX, _locationViewY, _locationViewWidth, _locationViewHeight);
...
- (void)layoutSubviews {
    ...
    _locationViewX     = CGRectGetMinX(_locationView.frame);
    _locationViewY     = CGRectGetMaxY(_locationView.frame);
    _locationViewWidth = CGRectGetWidth(_locationView.bounds);
    _listView.frame = CGRectMake(_locationViewX, _locationViewY, _locationViewWidth, _locationViewHeight);
}
